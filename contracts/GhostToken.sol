...
contract GhostToken is ERC20("GhostMixer", "GOMIX"), Ownable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "GOMIX::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "GOMIX::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "GOMIX::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "GOMIX::_writeCheckpoint: block number exceeds 32 bits"
            );
